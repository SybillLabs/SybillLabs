...
- Technologies : 
    ...
    - 🔎 Sécurité & Supervision : Zabbix, Graylog, Vaultwarden, Bareos, Audit de sécurité;
    - 📘 Documentation & Maintenance : GLPI, Guides d'exploitation, bonnes pratiques ITIL, sauvegardes 3-2-1-0.
- État : En cours
...
- Technologies : 
    ...
    - 🔎 Sécurité & Supervision : PRTG, Audit de sécurité;
    - 📘 Documentation & Maintenance : GLPI, Guides d'exploitation, bonnes pratiques ITIL.
...
- 📧 [Me contacter par email](mailto:sybillgribonval@gmail.com)
